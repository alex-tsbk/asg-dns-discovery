...
def register_services(di_container: DIContainer):
    ...
    if RUNTIME_CONTEXT.is_local_development:
        di_container.register(MetricsInterface, DevelopmentMetricsService)
        return

    env_config_service = di_container.resolve(EnvironmentConfigurationService)
    ...
    if RUNTIME_CONTEXT.is_aws and metrics_provider == "cloudwatch":
        ...
        di_container.register(MetricsInterface, AwsCloudwatchMetricsService)
