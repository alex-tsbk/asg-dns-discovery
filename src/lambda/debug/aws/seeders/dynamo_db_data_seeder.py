        ...
        records = [
            {
                ...
                "dns_config": {
                    ...
                    # all-operational, route53, empty mode: keep, ip v4 private value source, A
                    "record_name": "aa-r53-m_multi-em_keep-ipv4priv-A",
                    "record_ttl": 60,
                    "record_type": "A",
                    "srv_priority": 0,
                    "srv_weight": 0,
            ...
            },
            {
                ...
                "dns_config": {
                    ...
                    "value_source": "ip:v4:private",
                    "dns_zone_id": hosted_zone_id,
                    "record_name": "so-r53-m_multi-em_keep-ipv4priv-A",
                    "record_ttl": 60,
                    "record_type": "A",
                    "srv_priority": 0,
                    "srv_weight": 0,
            ...
            },
            {
                ...
                "dns_config": {
                    ...
                    "mode": "MULTIVALUE",
                    "empty_mode": "KEEP",
                    "value_source": "tag:dns_cname",
                    "dns_zone_id": hosted_zone_id,
                    "record_name": "so-r53-m_multi-em_keep-tag-CNAME",
                    "record_ttl": 60,
                    "record_type": "CNAME",
                    "srv_priority": 0,
                    "srv_weight": 0,
